...
_generateXMLHeader()
{
	local XML_HEADER="<!--DO NOT EDIT THIS FILE DIRECTLY. IT WAS GENERATED BY A SCRIPT AND IT IS GOING TO BE OVERWRITTEN!-->
<uid-message>
	<version>1.0</version>
	<type>update</type>
	<payload>
...
_getAPIKey()
{
	...
	echo "$CALL" | grep -F "<response status = 'success'>"
	if [[ $? != 0 ]]
	then
